<script lang="ts">
  import { PowerMethod, InversePowerMethod, QRAlgorithm, CompareTab } from '$lib/features/eigenvalues';

  type Tab = 'power' | 'inverse' | 'qr' | 'compare';
  let activeTab = $state<Tab>('power');
</script>
